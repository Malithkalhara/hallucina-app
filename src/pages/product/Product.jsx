...
import fashionHeader from "../../assets/img/fashion/fashion-header-bg-8.jpg";

export const Product = ({ title }) => {
  return (
    <div>
      <section id="aa-catg-head-banner">
        <img src={fashionHeader} alt="fashion img"></img>
                ...
                <div class="aa-product-catg-body">
                  <ul class="aa-product-catg">
                      ...
                      <figure>
                        ...
                        <figcaption>
                          ...
                          <p class="aa-product-descrip">
                            ...
                            elit. Numquam accusamus facere iusto, autem soluta
                            amet sapiente ratione inventore nesciunt a, maxime
                            quasi consectetur, rerum illum.
                          </p>
                        </figcaption>
                      </figure>
                    ...
                    <li>
                      ...
                      <span class="aa-badge aa-hot" href="#">
                        HOT!
                      </span>
                    </li>
